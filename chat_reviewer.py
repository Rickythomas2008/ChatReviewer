...
class Reviewer:
    ...
    def stage_1(self, paper):
        ...
        messages = [
            {"role": "system",
             "content": f"You are a fellow researcher in the field of {args.research_fields}. "
                        f"I will give you a paper. You need to review this paper and discuss the novelty and originality of ideas, the significance of results, potential impact and quality of the presentation. "
...
#         input_text_index = int(len(text)*(self.max_token_num-review_prompt_token)/text_token)
        ...
        messages=[
                {"role": "system", "content": "You are a fellow researcher in the field of "+args.research_fields+". Now I will give you a paper. You need to give a complete review opinion according to the following requirements and format:"+ review_format +" Please answer in {}.".format(self.language)},
...
def main(args):
    ...
    # 开始判断是路径还是文件：
    # paper_list = ['demo01.pdf', 'demo02.pdf','demo1.pdf']
    paper_list = []
